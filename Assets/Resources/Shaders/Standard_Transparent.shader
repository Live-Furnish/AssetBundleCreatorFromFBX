...
Shader "Custom/Transparent"
{
	Properties
	{
		...
		[Header(ALPHA)]_AlphaTexture("AlphaTexture", 2D) = "black" {}
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float cos6_g73 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _ParallaxMapRotation ) ) ) );
			float sin6_g73 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _ParallaxMapRotation ) ) ) );
			float2 rotator6_g73 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_ParallaxMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g73 , -sin6_g73 , sin6_g73 , cos6_g73 )) + float2( 0.5,0.5 );
			float3 ase_vertexNormal = v.normal.xyz;
			float4 HEIGHT176 = ( ( tex2Dlod( _ParallaxMap, float4( rotator6_g73, 0, 0.0) ) * float4( ase_vertexNormal , 0.0 ) ) * _Parallax );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float useGeneralRotation49 = (( _UseGeneralRotation )?( 1.0 ):( 0.0 ));
			float generalRotation70 = _GeneralRotation;
			float cos6_g70 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _BumpMapRotation ) ) ) );
			float sin6_g70 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _BumpMapRotation ) ) ) );
			float2 rotator6_g70 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_BumpMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g70 , -sin6_g70 , sin6_g70 , cos6_g70 )) + float2( 0.5,0.5 );
			float3 temp_output_244_13 = UnpackScaleNormal( tex2D( _BumpMap, rotator6_g70 ), _BumpScale );
			...
			float cos6_g74 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _EmissionMapRotation ) ) ) );
			float sin6_g74 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _EmissionMapRotation ) ) ) );
			float2 rotator6_g74 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_EmissionMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g74 , -sin6_g74 , sin6_g74 , cos6_g74 )) + float2( 0.5,0.5 );
			float4 EMISSION295 = ( tex2D( _EmissionMap, rotator6_g74 ) * _EmissionAmount * _EmissionColor );
			...
			float cos6_g71 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _SmoothnessMapRotation ) ) ) );
			float sin6_g71 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _SmoothnessMapRotation ) ) ) );
			float2 rotator6_g71 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_SmoothnessMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g71 , -sin6_g71 , sin6_g71 , cos6_g71 )) + float2( 0.5,0.5 );
			float4 temp_output_243_0 = tex2D( _SmoothnessMap, rotator6_g71 );
			...
			float cos6_g69 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _OcclusionMapRotation ) ) ) );
			float sin6_g69 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _OcclusionMapRotation ) ) ) );
			float2 rotator6_g69 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_OcclusionMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g69 , -sin6_g69 , sin6_g69 , cos6_g69 )) + float2( 0.5,0.5 );
			float4 temp_output_246_0 = tex2D( _OcclusionMap, rotator6_g69 );
...
/*ASEBEGIN
Version=18800
0;0;2560;1379;882.6956;-6010.183;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;246;-727.0776,5549.649;Inherit;False;TextureDegreeRotator;-1;;69;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;244;-720.0349,266.6935;Inherit;False;TextureDegreeRotator;-1;;70;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;243;-717.4187,3529.327;Inherit;False;TextureDegreeRotator;-1;;71;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;245;-732.3547,4602.745;Inherit;False;TextureDegreeRotator;-1;;73;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;292;-735.6451,1471.913;Inherit;False;TextureDegreeRotator;-1;;74;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
ASEEND*/
//CHKSM=31FD89538175B09029725600348B74F5651D1740
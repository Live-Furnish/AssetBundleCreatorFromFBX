...
Shader "Custom/Standard (CullOff)"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float cos6_g62 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _HeightMapRotation ) ) ) );
			float sin6_g62 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _HeightMapRotation ) ) ) );
			float2 rotator6_g62 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_ParallaxMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g62 , -sin6_g62 , sin6_g62 , cos6_g62 )) + float2( 0.5,0.5 );
			float3 ase_vertexNormal = v.normal.xyz;
			float4 HEIGHT176 = ( ( tex2Dlod( _ParallaxMap, float4( rotator6_g62, 0, 0.0) ) * float4( ase_vertexNormal , 0.0 ) ) * _Parallax );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float useGeneralRotation49 = (( _UseGeneralRotation )?( 1.0 ):( 0.0 ));
			float generalRotation70 = _GeneralRotation;
			float cos6_g59 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _BumpMapRotation ) ) ) );
			float sin6_g59 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _BumpMapRotation ) ) ) );
			float2 rotator6_g59 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_BumpMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g59 , -sin6_g59 , sin6_g59 , cos6_g59 )) + float2( 0.5,0.5 );
			float3 temp_output_244_13 = UnpackScaleNormal( tex2D( _BumpMap, rotator6_g59 ), _BumpScale );
			...
			float cos6_g61 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MainTexRotation ) ) ) );
			float sin6_g61 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MainTexRotation ) ) ) );
			float2 rotator6_g61 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_MainTex ) - float2( 0.5,0.5 ) , float2x2( cos6_g61 , -sin6_g61 , sin6_g61 , cos6_g61 )) + float2( 0.5,0.5 );
			...
			float2 uv3_DetailAlbedoMap = i.uv3_texcoord3 * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw;
				...
				float2 staticSwitch309 = uv_DetailAlbedoMap;
			#elif defined(_DETAILALBEDOUVSET_UV2)
				float2 staticSwitch309 = uv2_DetailAlbedoMap;
			#elif defined(_DETAILALBEDOUVSET_UV3)
				float2 staticSwitch309 = uv3_DetailAlbedoMap;
			#else
				float2 staticSwitch309 = uv2_DetailAlbedoMap;
			#endif
			float cos6_g57 = cos( radians( _DetailTexRotation ) );
			float sin6_g57 = sin( radians( _DetailTexRotation ) );
			float2 rotator6_g57 = mul( staticSwitch309 - float2( 0.5,0.5 ) , float2x2( cos6_g57 , -sin6_g57 , sin6_g57 , cos6_g57 )) + float2( 0.5,0.5 );
			float4 temp_output_311_0 = tex2D( _DetailAlbedoMap, rotator6_g57 );
			float temp_output_312_0 = (temp_output_311_0).a;
			float4 lerpResult229 = lerp( ( tex2D( _MainTex, rotator6_g61 ) * _Color ) , ( temp_output_311_0 * temp_output_312_0 * _DetailAlbedoColor ) , (( _UseDetailAlbedoMap )?( temp_output_312_0 ):( 0.0 )));
			float4 ALBEDO29 = lerpResult229;
			o.Albedo = ALBEDO29.rgb;
			float2 uv_EmissionMap = i.uv_texcoord * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
			float cos6_g64 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _EmissionMapRotation ) ) ) );
			float sin6_g64 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _EmissionMapRotation ) ) ) );
			float2 rotator6_g64 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_EmissionMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g64 , -sin6_g64 , sin6_g64 , cos6_g64 )) + float2( 0.5,0.5 );
			float4 EMISSION295 = ( tex2D( _EmissionMap, rotator6_g64 ) * _EmissionAmount * _EmissionColor );
			o.Emission = EMISSION295.rgb;
			float2 uv_MetallicGlossMap = i.uv_texcoord * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
			float cos6_g63 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MetallicGlossMapRotation) ) ) );
			float sin6_g63 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _MetallicGlossMapRotation) ) ) );
			float2 rotator6_g63 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_MetallicGlossMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g63 , -sin6_g63 , sin6_g63 , cos6_g63 )) + float2( 0.5,0.5 );
			//float4 METALLIC274 = ( tex2D( _MetallicGlossMap, rotator6_g63 ) * _Metallic );
			float4 temp_output_metallic = tex2D(_MetallicGlossMap, rotator6_g63);
			...
			float cos6_g58 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _SmoothnessMapRotation ) ) ) );
			float sin6_g58 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _SmoothnessMapRotation ) ) ) );
			float2 rotator6_g58 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_SmoothnessMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g58 , -sin6_g58 , sin6_g58 , cos6_g58 )) + float2( 0.5,0.5 );
			float4 temp_output_243_0 = tex2D( _SmoothnessMap, rotator6_g58 );
			...
			float cos6_g60 = cos( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _OcclusionMapRotation ) ) ) );
			float sin6_g60 = sin( radians( ( 360.0 - ( useGeneralRotation49 == 1.0 ? generalRotation70 : _OcclusionMapRotation ) ) ) );
			float2 rotator6_g60 = mul( ( useGeneralTillingOffset52 == 1.0 ? generalUV148 : uv_OcclusionMap ) - float2( 0.5,0.5 ) , float2x2( cos6_g60 , -sin6_g60 , sin6_g60 , cos6_g60 )) + float2( 0.5,0.5 );
			float4 temp_output_246_0 = tex2D( _OcclusionMap, rotator6_g60 );
...
/*ASEBEGIN
Version=18800
-1920;716;1920;1013;4255.404;356.7664;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;85;-1563.68,-1760.046;Inherit;False;2567.091;1460.862;;27;247;29;229;232;230;227;278;228;231;221;146;66;95;150;87;149;81;23;83;82;311;312;306;307;308;309;310;ALBEDO;0.8235294,0.5104133,0.3803922,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1506.585,-1165.669;Inherit;False;Property;_MainTexRotation;MainTexRotation;11;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;82;-1450.479,-1331.008;Inherit;False;49;useGeneralRotation;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;83;-1438.667,-1254.315;Inherit;False;70;generalRotation;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;308;-1109.78,-845.9073;Inherit;False;2;218;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;307;-1109.78,-972.9073;Inherit;False;1;218;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;306;-1107.729,-1096.181;Inherit;False;0;218;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Compare;81;-1158.266,-1267.602;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;87;-1474.579,-1660.556;Inherit;False;52;useGeneralTillingOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;149;-1400.445,-1585.464;Inherit;False;148;generalUV;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.StaticSwitch;309;-839.5895,-996.3789;Inherit;False;Property;_DetailAlbedoUVSet;DetailAlbedoUVSet;43;0;Create;True;0;0;0;False;0;False;0;1;1;True;;KeywordEnum;3;UV1;UV2;UV3;Create;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;150;-1441.445,-1499.464;Inherit;False;0;64;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;221;-712.2145,-1240.959;Inherit;False;219;detailAlbedo;1;0;OBJECT;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;310;-836.572,-848.2897;Inherit;False;Property;_DetailTexRotation;DetailTexRotation;42;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;243;-717.4187,3529.327;Inherit;False;TextureDegreeRotator;-1;;58;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;244;-720.0349,266.6935;Inherit;False;TextureDegreeRotator;-1;;59;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;95;-988.1894,-1334.539;Inherit;False;2;0;FLOAT;360;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;66;-1033.45,-1671.8;Inherit;False;65;albedoTexture;1;0;OBJECT;;False;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.FunctionNode;246;-727.0776,5549.649;Inherit;False;TextureDegreeRotator;-1;;60;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;311;-477.6165,-1241.75;Inherit;False;TextureDegreeRotator;-1;;57;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.Compare;146;-1128.217,-1546.214;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;231;-682.6059,-1435.981;Inherit;False;Property;_Color;AlbedoColor;10;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;278;-180.1751,-995.5059;Inherit;False;Property;_DetailAlbedoColor;DetailAlbedoColor;41;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;247;-734.9548,-1618.251;Inherit;False;TextureDegreeRotator;-1;;61;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;228;-73.52987,-1387.102;Inherit;False;Constant;_Float2;Float 2;26;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;312;-162.0496,-1110.986;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;245;-732.3547,4602.745;Inherit;False;TextureDegreeRotator;-1;;62;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;292;-735.6451,1471.913;Inherit;False;TextureDegreeRotator;-1;;64;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;268;-713.8727,2585.518;Inherit;False;TextureDegreeRotator;-1;;63;5f28bc49243818546bb1e8d97bb48d35;0;4;1;SAMPLER2D;;False;3;FLOAT2;0,0;False;9;FLOAT;0;False;14;FLOAT;0;False;2;FLOAT3;13;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;232;-389.7455,-1518.672;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;230;70.15517,-1236.895;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;227;275.1177,-1246.732;Inherit;True;Property;_UseDetailAlbedoMap;UseDetailAlbedoMap;40;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;229;559.5138,-1525.888;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;29;802.4051,-1527.953;Inherit;False;ALBEDO;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;302;-3424.439,166.3215;Inherit;False;Property;_SrcBlend;SrcBlend;2;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;5;1;False;0;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode;213;1731.377,-519.5734;Inherit;False;212;ALPHA;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;303;-3422.439,252.3215;Inherit;False;Property;_DstBlend;DstBlend;3;1;[Enum];Create;False;0;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;0;False;0;1;INT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2125.793,-1140.789;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Custom/Standard (CullOff);False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;1;True;299;0;False;300;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;6;True;302;1;True;303;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;304;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;311;1;221;0
WireConnection;311;3;309;0
WireConnection;311;9;310;0
...
WireConnection;230;0;311;0
WireConnection;230;1;312;0
WireConnection;230;2;278;0
WireConnection;227;0;228;0
WireConnection;227;1;312;0
...
ASEEND*/
//CHKSM=1F4A2F5B1D25CC186C2800674868C25953AAE883